...
<body class="px-2">
    ...
    <!-- fin de encabezado -->
     ...
     <div class="container mt-4">
        ...
        <p>sin importar cual es tu negocio, nuestro equipo puede hacerlo desde cero.</p>
        <div class="row">
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        <img class="w-100" src="./resources/img/idea_01.PNG" alt="">
                        <h5 class="h5 mt-2"><i class="bi bi-pencil-square"></i>  DISEÑO</h5>
                        <p>creamos diseño segun tus necesidades.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <p>nuestros programadores te garantizaran la perfección.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <h5 class="h5 mt-2"><i class="bi bi-plus-square-fill"></i>  EDICION DE LIBROS</h5>
